                ...
                iconComponent: (
                    <Svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <G clip-path="url(#clip0_1064_7395)">
                            ...
                            />
                            <Path
                                d="M7.99967 1.33301C9.66719 3.15858 10.6148 5.5277 10.6663 7.99967C10.6148 10.4717 9.66719 12.8408 7.99967 14.6663C6.33215 12.8408 5.38451 10.4717 5.33301 7.99967C5.38451 5.5277 6.33215 3.15858 7.99967 1.33301Z"
                                stroke="#FAFAFA"
                                stroke-width="1.33333"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                iconComponent: (
                    <Svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <G clip-path="url(#clip0_1431_1972)">
                            <Path
                                d="M4.66634 7.33301L7.33301 1.33301C7.86344 1.33301 8.37215 1.54372 8.74722 1.91879C9.12229 2.29387 9.33301 2.80257 9.33301 3.33301V5.99967H13.1063C13.2996 5.99749 13.4911 6.03734 13.6674 6.11649C13.8437 6.19563 14.0008 6.31216 14.1276 6.45802C14.2544 6.60387 14.348 6.77556 14.4019 6.96118C14.4558 7.1468 14.4687 7.34191 14.4397 7.53301L13.5197 13.533C13.4715 13.8509 13.31 14.1407 13.0649 14.349C12.8199 14.5573 12.5079 14.67 12.1863 14.6663H4.66634M4.66634 7.33301V14.6663M4.66634 7.33301H2.66634C2.31272 7.33301 1.97358 7.47348 1.72353 7.72353C1.47348 7.97358 1.33301 8.31272 1.33301 8.66634V13.333C1.33301 13.6866 1.47348 14.0258 1.72353 14.2758C1.97358 14.5259 2.31272 14.6663 2.66634 14.6663H4.66634"
                                stroke="#FAFAFA"
                                stroke-width="1.5"
                                stroke-linecap="round"
                                stroke-linejoin="round"
